...
The release candidate passed 17 tests, 98.16% branch-aware coverage, schema validation, metric reproduction, figure generation, and the main and supplementary LaTeX builds before publication.
...
The source follows the Elsevier `elsarticle` structure used for an SLAS Technology Original Research submission. Compiled submission assets are distributed in the versioned archival package.
