...
| [submission_audit_v0.1.4.md](submission_audit_v0.1.4.md) | **Current** audit record: 205 tests at 95.73% coverage, 31 validated release CSVs, 24-row source/quotation audit ledger, robustness table sync + denominator mutation tests. PDF/TeX certification still pending Linux/TeX Live. |
| [release_notes_v0.1.4.md](release_notes_v0.1.4.md) | **Current** release notes: test-contract repair, source ledger, 0.1.4 metadata, blind-coding issue correction. |
