...
Supplementary Table~S2 exposes the dependence of these four rubric means on the numerical value assigned to a partial field. Replacing 0.5 with values from 0 through 1 moves IAS from 38.9\% to 88.9\%, RMC from 21.7\% to 86.7\%, PDC from 50.0\% to 84.1\%, and OC from 25.0\% to 80.0\%. The midpoint values remain the declared summaries. The ranges show why the means should be interpreted as transparent rubric compressions and not as calibrated probabilities or a common performance scale.
...
The leave-one-thread-out analysis in Supplementary Table~S3 retained B5--B6, B5--B8, and B2--B7 among the leading three pairs under every deletion. B4--B8 remained in the top five under all 55 deletions. B8--B9 fell to rank six under two deletions and retained the joint phi/lift attention threshold under 16 of 55 deletions. This result supports the first four relationships as stable priorities for prospective study and reinforces the exploratory treatment of B8--B9.
