...
This checklist maps the release to the current SLAS author requirements and the NexusXp special-issue call.
...
- [x] Public-data minimization and quotation policy documented
...
- [ ] Upload the main manuscript, supplement, cover letter, highlights, and graphical abstract
- [ ] Perform a final proof against the portal-generated PDF

## Final gate

The manuscript should be submitted only when every numerical statement can be traced to a committed input, every quotation has been context-checked against its source discussion, and every repository path and source link resolves.
