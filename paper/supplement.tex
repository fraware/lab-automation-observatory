...
The partial-score analysis changes the numerical level of each rubric summary, as expected, but makes that dependence explicit. It does not create a basis for ranking IAS, RMC, PDC, and OC against one another. The leave-one-thread-out analysis retains B5--B6, B5--B8, and B2--B7 in the leading three positions across all 55 deletions. B4--B8 remains in the top five throughout. B8--B9 falls to rank six under two deletions and retains the pilot attention threshold under 16 of 55 deletions; it is therefore interpreted as exploratory.
